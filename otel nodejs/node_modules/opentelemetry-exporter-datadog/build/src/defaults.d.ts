export declare enum DatadogDefaults {
...
export declare enum DatadogSamplingCodes {
...
export declare enum DatadogExportDefaults {
...
export declare enum DatadogPropagationDefaults {
...
export declare enum DatadogOtelInstrumentations {
...
export declare enum DatadogInstrumentationTypes {
    WEB = "web",
    HTTP = "http",
    MONGODB = "mongodb",
    REDIS = "redis",
